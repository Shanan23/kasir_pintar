...
class RetrofitClient {
    ...
    private static final String BASE_URL = "https://api.mailgun.net/v3/sandbox9098277bd371485db93041d4f7f2f601.mailgun.org/";

    private static final String API_USERNAME = "api";

    //you need to change the value to your API key
    private static final String API_PASSWORD = "42aa8f362f0734605566286e081a5d67-07f37fca-1b5f9398";
