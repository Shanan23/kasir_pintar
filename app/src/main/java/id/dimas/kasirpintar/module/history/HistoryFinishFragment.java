 ...
 * Use the {@link HistoryFinishFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class HistoryFinishFragment extends Fragment {
     ...
     * @return A new instance of fragment HistoryFinishFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static HistoryFinishFragment newInstance(String param1, String param2) {
        HistoryFinishFragment fragment = new HistoryFinishFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_history_finish, container, false);
    ...
    private void retrieveOrders() {
        new Thread(() -> {
            List<Orders> allOrdersByStatus = appDatabase.ordersDao().getAllOrdersByStatus(MyApp.Status.COMPLETED.name());
