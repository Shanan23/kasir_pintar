        ...
        new Thread(() -> {
            ...
            if (ordersList != null) {
                for (int i = 0; i < ordersList.size(); i++) {
                    List<OrdersDetail> ordersDetailList = appDatabase.ordersDetailDao().getAllOrdersDetailById(ordersList.get(i).getId(), selectedDateRange.split("-")[0], selectedDateRange.split("-")[1]);
